...
namespace MismeAPI.Data.Migrations
{
    ...
    [Migration("20210601031152_add_object_type_to_orders")]
    partial class add_object_type_to_orders
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MismeAPI.Data.Entities.App", b =>
                {
                    ...
                    b.Property<bool>("IsMandatoryIOS")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("MismeAPI.Data.Entities.Group", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MismeAPI.Data.Entities.GroupInvitation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MismeAPI.Data.Entities.GroupServicePrice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MismeAPI.Data.Entities.HandConversionFactor", b =>
                {
                    ...
                    b.Property<double>("ConversionFactor19Code")
                        .HasColumnType("double");

                    b.Property<double>("ConversionFactor3Code")
                        .HasColumnType("double");

                    b.Property<double>("ConversionFactor4Code")
                        .HasColumnType("double");
            ...
            modelBuilder.Entity("MismeAPI.Data.Entities.Menu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MismeAPI.Data.Entities.MenuEat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MismeAPI.Data.Entities.MenuEatCompoundDish", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MenuEatId");

                    b.ToTable("menueatcompounddish");
                });

            modelBuilder.Entity("MismeAPI.Data.Entities.MenuEatDish", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MismeAPI.Data.Entities.ScheduledEmail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("scheduledemail");
                });

            modelBuilder.Entity("MismeAPI.Data.Entities.Service", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MismeAPI.Data.Entities.ServicePrice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MismeAPI.Data.Entities.GroupInvitation", b =>
                {
                    b.HasOne("MismeAPI.Data.Entities.Group", "Group")
            ...
            modelBuilder.Entity("MismeAPI.Data.Entities.GroupServicePrice", b =>
                {
                    ...
                    b.HasOne("MismeAPI.Data.Entities.ServicePrice", "ServicePrice")
                        .WithMany()
            ...
            modelBuilder.Entity("MismeAPI.Data.Entities.MenuEat", b =>
                {
                    b.HasOne("MismeAPI.Data.Entities.Menu", "Menu")
                        .WithMany("Eats")
            ...
            modelBuilder.Entity("MismeAPI.Data.Entities.MenuEatCompoundDish", b =>
                {
                    ...
                    b.HasOne("MismeAPI.Data.Entities.MenuEat", "MenuEat")
                        .WithMany("EatCompoundDishes")
                        .HasForeignKey("MenuEatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("MismeAPI.Data.Entities.ServicePrice", b =>
                {
                    b.HasOne("MismeAPI.Data.Entities.Service", "Service")
                        .WithMany()
